...
function X(d) {
  ...
  for (let m = 0; m < 8 * d.length; m += 8) {
    r[m >> 5] |= (255 & d.charCodeAt(m / 8)) << (m % 32);
  }
  return r;
}
  ...
  for (let n = 0; n < d.length; n += 16) {
    ...
    ((f = ii(
      (f = ii(
        (f = ii(
          (f = ii(
            (f = hh(
              (f = hh(
                (f = hh(
                    ...
                    (f = gg(
                      (f = gg(
                        (f = gg(
                          (f = gg(
                            (f = ff(
                              (f = ff(
                                (f = ff(
                                  (f = ff(
                                    ...
                                    (r = ff(
                                      ...
                                      (i = ff(
                                        i,
                                        (m = ff(m, f, r, i, d[n + 0], 7, -680876936)),
                                        f,
                                        r,
                                        d[n + 1],
                                        12,
                                  ...
                                  (r = ff(
                                    ...
                                    (i = ff(
                                      i,
                                      (m = ff(m, f, r, i, d[n + 4], 7, -176418897)),
                                      f,
                                      r,
                                      d[n + 5],
                                      12,
                                ...
                                (r = ff(
                                  ...
                                  (i = ff(
                                    i,
                                    (m = ff(m, f, r, i, d[n + 8], 7, 1770035416)),
                                    f,
                                    r,
                                    d[n + 9],
                                    12,
                              ...
                              (r = ff(
                                ...
                                (i = ff(
                                  i,
                                  (m = ff(m, f, r, i, d[n + 12], 7, 1804603682)),
                                  f,
                                  r,
                                  d[n + 13],
                                  12,
                            ...
                            (r = gg(
                              ...
                              (i = gg(
                                i,
                                (m = gg(m, f, r, i, d[n + 1], 5, -165796510)),
                                f,
                                r,
                                d[n + 6],
                                9,
                          ...
                          (r = gg(
                            ...
                            (i = gg(
                              i,
                              (m = gg(m, f, r, i, d[n + 5], 5, -701558691)),
                              f,
                              r,
                              d[n + 10],
                              9,
                        ...
                        (r = gg(
                          ...
                          (i = gg(
                            i,
                            (m = gg(m, f, r, i, d[n + 9], 5, 568446438)),
                            f,
                            r,
                            d[n + 14],
                            9,
                      ...
                      (r = gg(
                        ...
                        (i = gg(
                          i,
                          (m = gg(m, f, r, i, d[n + 13], 5, -1444681467)),
                          f,
                          r,
                          d[n + 2],
                          9,
                  ...
                  (r = hh(
                    ...
                    (i = hh(
                      i,
                      (m = hh(m, f, r, i, d[n + 1], 4, -1530992060)),
                      f,
                      r,
                      d[n + 4],
                      11,
                ...
                (r = hh(
                  ...
                  (i = hh(
                    i,
                    (m = hh(m, f, r, i, d[n + 13], 4, 681279174)),
                    f,
                    r,
                    d[n + 0],
                    11,
              ...
              (r = hh(
                ...
                (i = hh(
                  i,
                  (m = hh(m, f, r, i, d[n + 9], 4, -640364487)),
                  f,
                  r,
                  d[n + 12],
                  11,
            ...
            (r = ii(
              ...
              (i = ii(
                i,
                (m = ii(m, f, r, i, d[n + 0], 6, -198630844)),
                f,
                r,
                d[n + 7],
                10,
          ...
          (r = ii(
            ...
            (i = ii(
              i,
              (m = ii(m, f, r, i, d[n + 12], 6, 1700485571)),
              f,
              r,
              d[n + 3],
              10,
        ...
        (r = ii(
          ...
          (i = ii(
            i,
            (m = ii(m, f, r, i, d[n + 8], 6, 1873313359)),
            f,
            r,
            d[n + 15],
            10,
      ...
      (r = ii(
        ...
        (i = ii(
          i,
          (m = ii(m, f, r, i, d[n + 4], 6, -145523070)),
          f,
          r,
          d[n + 11],
          10,
